...
export default {
  ...
  actions: {
    ...
    async getHuntSolution({ rootState }) {
    ...
    async updateHunt({ commit, dispatch, rootState }) {
      let huntId = rootState.hunt.currentHunt.huntId;
      let huntDoc = rootState.hunt.currentHunt.huntData;
    ...
    updateHuntClueAnswers({ state, rootState }) {
    ...
    updateHuntScavAnswers({ commit, state, rootState }) {
      // eslint-disable-next-line
